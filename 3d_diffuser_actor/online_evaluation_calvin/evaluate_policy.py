...
def evaluate_policy(model, env, conf_dir, eval_log_dir=None, save_video=False,
                    sequence_indices=[], use_mono_depth=False, depth_model=None, depth_model_transform=None, 
    ...
    for seq_ind, (initial_state, eval_sequence) in enumerate(eval_sequences):
        print(f"Evaluating sequence {seq_ind}...")
...
def evaluate_sequence(env, model, task_checker, initial_state, eval_sequence,
                      val_annotations, save_video, use_mono_depth=False, depth_model=None, depth_model_transform=None, 
                      depth_predict_function=None):
    """
...
def rollout(env, model, task_oracle, subtask, lang_annotation,
            use_mono_depth=False, depth_model=None, depth_model_transform=None, 
            depth_predict_function=None):
    """
...
def main(args):
    ...
    if args.use_mono_depth:
        ...
        depth_model, depth_model_transform = None, None
        depth_predict_function = None
