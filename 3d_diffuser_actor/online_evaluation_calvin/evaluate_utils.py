...
from utils.common_utils import save_pil, save_depth_16bit
...
def prepare_visual_states(obs: Dict[str, Dict[str, Any]],
    ...
    if use_mono_depth:
        ...
        intrinsics_static = static_cam.get_intrinsic_matrix()
        intrinsics_gripper = gripper_cam.get_intrinsic_matrix()
        
        mono_depth_static = depth_predict_function(
            depth_model=depth_model,
            depth_model_transform=depth_model_transform,
            rgb_img=rgb_static,
            f_px=fx_static,
            intrinsics=intrinsics_static,
        )
        
        mono_depth_gripper = depth_predict_function(
            depth_model=depth_model,
            depth_model_transform=depth_model_transform,
            rgb_img=rgb_gripper,
            f_px=fx_gripper,
            intrinsics=intrinsics_gripper,
        )
        
        # save_pil(rgb_static, "rgb_static.png")
        # save_pil(rgb_gripper, "rgb_gripper.png")
        # save_depth_16bit(depth_static, "depth_static.png")
        # save_depth_16bit(depth_gripper, "depth_gripper.png")
        # save_depth_16bit(mono_depth_gripper, "mono_depth_gripper.png")
        # save_depth_16bit(mono_depth_static, "mono_depth_static.png")
        # exit()
        
        depth_static = mono_depth_static
        depth_gripper = mono_depth_gripper
