...
class TaskEnvironment(object):
    ...
    def reset(self, use_mono_depth=False, depth_model=None, depth_model_transform=None, depth_predict_function=None) -> (List[str], Observation):
        self._scene.reset()
        try:
        ...
        return desc, self._scene.get_observation(use_mono_depth=use_mono_depth, depth_model=depth_model, depth_model_transform=depth_model_transform, depth_predict_function=depth_predict_function)

    def get_task_descriptions(self) -> List[str]:
        return self._scene.task.init_episode(self._variation_number)

    def get_observation(self, use_mono_depth=False, depth_model=None, depth_model_transform=None, depth_predict_function=None) -> Observation:
        return self._scene.get_observation(use_mono_depth=use_mono_depth, depth_model=depth_model, depth_model_transform=depth_model_transform, depth_predict_function=depth_predict_function)

    def step(self, action,
             use_mono_depth=False,
             depth_model=None,
             depth_model_transform=None,
             depth_predict_function=None) -> (Observation, int, bool):
        ...
        return self._scene.get_observation(use_mono_depth=use_mono_depth, depth_model=depth_model, depth_model_transform=depth_model_transform, depth_predict_function=depth_predict_function), reward, terminate
    ...
    def reset_to_demo(self, demo: Demo, use_mono_depth=False, depth_model=None, depth_model_transform=None, depth_predict_function=None) -> (List[str], Observation):
        demo.restore_state()
        return self.reset(use_mono_depth=use_mono_depth, depth_model=depth_model, depth_model_transform=depth_model_transform, depth_predict_function=depth_predict_function)
